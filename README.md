...
I'm also deeply invested in **product development** and the **startup ecosystem** — I like being close to the "why" behind what I'm building, not just the "how."
...
| Domain | Description |
|---|---|
| 🌐 **Frontend Development** | Crafting responsive, performant, and accessible user interfaces |
| ⚙️ **Backend Development** | Building scalable APIs, databases, and authentication systems |
| 🤖 **AI Integration** | Embedding LLM-powered features into real products |
| 📡 **IoT & Embedded Systems** | Bridging microcontrollers, sensors, and cloud software |
...
Responsive agency website showcasing branding, digital marketing, business consulting, web development, and lead generation.
...
Learning management platform with professional courses, enrollment workflows, and a modern learning experience.
...
**Highlights:**
- Destination discovery with rich search
- Accommodation listing management
- End-to-end booking workflow
- Fully responsive travel-first UI

</td>
<td width="50%" valign="top">

### 🔹 Travel Deep Into India

Travel booking platform with a premium UI, curated tour packages, and a smooth booking experience.
...
**Highlights:**
- Clean, credibility-focused business layout
...
Responsive business platform focused on simplicity and speed.
...
**Highlights:**
- Streamlined, easy-to-navigate UI
...
Startup showcase platform built using React and Node.js.
...
Educational platform for electronics projects, technical blogs, documentation, and learning resources.
...
Secure online examination platform featuring authentication, an admin dashboard, monitoring, and anti-cheating mechanisms.
...
IoT automation project using Arduino, GSM, ultrasonic and IR sensors, servo and stepper motors, and a rain sensor.
...
**Highlights:**
- Real-time waste-level detection via ultrasonic sensing
- GSM-based alert notifications
- Automated bin lid control via servo motor
- Rain-sensor triggered protective automation
...
Emergency alert system built using embedded hardware and IoT technologies.
...
- Location-based alert notification system
- Compact, wearable embedded hardware design
...
Embedded electronics project focused on robotics and automation.
...
Python-based desktop application for cafe management.
...
### 🧑‍💻 Portfolio Websites
Clean, modern portfolios that reflect your personal brand.

</td>
<td width="33%" align="center">

### 🎯 Landing Pages
High-converting, fast-loading pages for products and campaigns.
...
### 📊 Admin Dashboards
Data-rich dashboards for managing operations and users.

</td>
<td width="33%" align="center">

### 🎓 Learning Platforms
Scalable platforms for courses, enrollment, and progress tracking.
...
### 🤖 AI Integration
Adding LLM-powered features and intelligent automation.

</td>
<td width="33%" align="center">

### 🔌 REST APIs
Secure, well-documented, and scalable backend APIs.
...
Workflow and process automation for businesses and systems.

</td>
<td width="33%" align="center">

### 📡 IoT Systems
Sensor-driven, connected systems bridging hardware and cloud.

</td>
<td width="33%" align="center">

### 🔧 Embedded Solutions
Microcontroller-based embedded systems built for reliability.
...
### 🎨 Website Redesign
Modernizing outdated websites with fresh design and structure.
...
Alongside web development, I've worked hands-on with **IoT projects** and **embedded systems** — building automation systems with microcontrollers, sensors, and real-time monitoring, and integrating **AI capabilities** into applications to add intelligent, user-facing features.

Across all of this work, I consistently prioritize **performance optimization** and **responsive design**, making sure every product I ship feels fast, polished, and reliable — on any device, for any user.
...
<td>BIT Patna × ISRO</td>
</tr>
<tr>
<td>🏆 Smart India Hackathon</td>
<td>Internal Round Selected</td>
</tr>
<tr>
<td>🏆 TECHNEX Hackathon</td>
<td>IIT BHU</td>
</tr>
<tr>
...
<tr>
<td>🏆 PLC Programming Internship</td>
<td>TRTC</td>
</tr>
<tr>
<td>🏆 IEEE Nano Day Workshop</td>
<td>IIT Patna</td>
</tr>
<tr>
<td>🏆 IoT Advanced Workshop</td>
<td>Completed</td>
</tr>
<tr>
